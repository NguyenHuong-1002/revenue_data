...
export function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      {/* Modal box */}
      <div className="relative w-full max-w-lg rounded-xl bg-card border border-border shadow-2xl p-6 overflow-hidden animate-in fade-in zoom-in-95 duration-200 z-10">
