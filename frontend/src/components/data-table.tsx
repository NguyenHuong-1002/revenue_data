            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Hiển thị tổng lượt truy cập trong 6 tháng qua. Đây là văn bản
                  ngẫu nhiên để kiểm tra bố cục. Nó trải dài nhiều dòng và nên
                  tự động xuống dòng.
                </div>
              </div>
              <Separator />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Select defaultValue={item.type}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="Mục lục">
                        Mục lục
                      </SelectItem>
                      <SelectItem value="Tóm tắt điều hành">
                        Tóm tắt điều hành
                      </SelectItem>
                      <SelectItem value="Cách tiếp cận kỹ thuật">
                        Cách tiếp cận kỹ thuật
                      </SelectItem>
                      <SelectItem value="Thiết kế">Thiết kế</SelectItem>
                      <SelectItem value="Năng lực">Năng lực</SelectItem>
                      <SelectItem value="Tài liệu trọng tâm">
                        Tài liệu trọng tâm
                      </SelectItem>
