...
export class ProductItemDto {
  ...
  @ApiProperty({ example: 'MEN', enum: ['MEN', 'WOM', 'BOY', 'GIR'], description: 'Đối tượng giới tính phù hợp' })
  ...
  @ApiProperty({
    ...
    enum: ['24 đến <40 tuổi', '40 đến <60 tuổi', '0 đến <3 tuổi', 'Trên 60 tuổi', '6 đến <10 tuổi', '3 đến <6 tuổi', '10 đến <16 tuổi', 'Khác'],
...
export class PaginatedProductsResponseDto {
  @ApiProperty({ type: [ProductItemDto], description: 'Danh sách sản phẩm tương ứng trang hiện tại' })
  data!: ProductItemDto[];
